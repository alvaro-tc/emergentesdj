# [Django React Berry](https://app-generator.dev/product/berry-dashboard/api-django/react/)

`Full-Stack` Seed project provided by [App Generator](https://app-generator.dev/) on top of **[Berry Dashboard](https://app-generator.dev/product/berry-dashboard/)** design. 
...
- 👉 [Django React Berry](https://app-generator.dev/product/berry-dashboard/api-django/react/) - `Product page`
...
---
**[Django React Berry](https://app-generator.dev/product/berry-dashboard/api-django/react/)** - `Full-Stack` Seed project provided by **[App-Generator](https://app-generator.dev/)**.
